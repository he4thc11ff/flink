...
public class Application {
    public static void main(String[] args) throws Exception {
        ...
        Pattern<Event, Event> start = Pattern.<Event>begin("start").where(new IterativeCondition<Event>() {
            @Override
        ...
        Pattern<Event, Event> end = start.next("end").where(new IterativeCondition<Event>() {
            @Override
            public boolean filter(Event event, Context<Event> context) throws Exception {
